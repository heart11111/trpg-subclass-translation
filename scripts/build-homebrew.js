...
const classArt = {
  ...
  '아티피서': 'assets/images/homebrew-tome-v2.jpg',
...
const subclassArt = {
  ...
  'UA 원시 후원자 - Primordial Patron': 'assets/images/subclasses-v2/ua-primordial-patron.webp',
  'UA 흔적 후원자 - Vestige Patron': 'assets/images/subclasses-v2/ua-vestige-patron.webp',
  'UA 소서러-왕 후원자 - Sorcerer-King Patron': 'assets/images/subclasses-v2/ua-sorcerer-king-patron.webp',
  ...
  'UA 비전 궁수 - Arcane Archer': 'assets/images/subclasses-v2/ua-arcane-archer.webp',
  'UA 기병 - Cavalier': 'assets/images/subclasses-v2/ua-cavalier.webp',
  'UA 검투사 - Gladiator': 'assets/images/subclasses-v2/ua-gladiator.webp',
  ...
  'UA 역병 권역 - Pestilence Domain': 'assets/images/subclasses-v2/ua-pestilence-domain.webp',
  'UA 비전 권역 - Arcana Domain': 'assets/images/subclasses-v2/ua-arcana-domain.webp',
  ...
  'UA 주문수호자의 맹세 - Oath of the Spellguard': 'assets/images/subclasses-v2/ua-oath-of-the-spellguard.webp',
  'UA 맹세파괴자 - Oathbreaker': 'assets/images/subclasses-v2/ua-oathbreaker.webp',
  ...
  'UA 보존의 회합 - Circle of Preservation': 'assets/images/subclasses-v2/ua-circle-of-preservation.webp',
  ...
  'UA 신비술 전사 - Warrior of the Mystic Arts': 'assets/images/subclasses-v2/ua-warrior-of-the-mystic-arts.webp',
  'UA 독의 전사 - Warrior of Venom': 'assets/images/subclasses-v2/ua-warrior-of-venom.webp',
  'UA 문신 전사 - Tattooed Warrior': 'assets/images/subclasses-v2/ua-tattooed-warrior.webp',
  'UA 취권 전사 - Warrior of Intoxication': 'assets/images/subclasses-v2/ua-warrior-of-intoxication.webp',
  '엑상귀네이터 로그 - Exsanguinator Rogue': 'assets/images/homebrew-classes/rogue.jpg',
  'UA 마법 도둑 - Magic Stealer': 'assets/images/subclasses-v2/ua-magic-stealer.webp',
  ...
  'UA 비탄의 길 - Path of Lament': 'assets/images/subclasses-v2/ua-path-of-lament.webp',
  'UA 영적 수호자의 길 - Path of the Spiritual Guardian': 'assets/images/subclasses-v2/ua-path-of-the-spiritual-guardian.webp',
  'UA 폭풍 전령의 길 - Path of the Storm Herald': 'assets/images/subclasses-v2/ua-path-of-the-storm-herald.webp',
  ...
  'UA 악마 혈통 마법 - Demonic Sorcery': 'assets/images/subclasses-v2/ua-demonic-sorcery.webp',
  'UA 선조 마법 - Ancestral Sorcery': 'assets/images/subclasses-v2/ua-ancestral-sorcery.webp',
  'UA 황폐화 마법 - Defiled Sorcery': 'assets/images/subclasses-v2/ua-defiled-sorcery.webp',
  'UA 조형술사 - Conjurer': 'assets/images/subclasses-v2/ua-conjurer.webp',
  'UA 환혹술사 - Enchanter': 'assets/images/subclasses-v2/ua-enchanter.webp',
  'UA 사령술사 - Necromancer': 'assets/images/subclasses-v2/ua-necromancer.webp',
  'UA 변환술사 - Transmuter': 'assets/images/subclasses-v2/ua-transmuter.webp',
  ...
  'UA 사이언 - Psion': 'assets/images/subclasses-v2/ua-psion.webp',
};

const classNotes = {
  '워록': '후원자, 피의 계약, 운명의 실처럼 초자연적 대가를 중심으로 한 서브클래스입니다.',
  '아티피서': '마법공학 장치와 제작 기법으로 전투 역할을 바꾸는 발명가 계열 서브클래스입니다.',
...
const cardSynopsisOverrides = {
  '하프오크 - Half Orc': '인간과 오크의 혈통을 함께 지닌 강인한 종족 옵션입니다.',
